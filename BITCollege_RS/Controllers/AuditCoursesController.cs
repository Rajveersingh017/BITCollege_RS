...
namespace BITCollege_RS.Controllers
{
    public class AuditCoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,AcademicProgramId,CourseNumber,Title,CreditHours,TutionAmount,Notes")] AuditCourse auditCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,AcademicProgramId,CourseNumber,Title,CreditHours,TutionAmount,Notes")] AuditCourse auditCourse)
        {
            if (ModelState.IsValid)
            {
